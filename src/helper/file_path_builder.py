...
class GetFilePath:
    ...
    def file_path(self, subcategory: str, category_dir: str) -> str:
        file_name = f"{subcategory}_{self.random_key()}.pdf"
        return os.path.join(category_dir, file_name)

    async def get_file_path(self, file_url: str, category: str, subcategory: str) -> str:
        try:
            ...
            file_path = self.file_path(subcategory, category_dir)
